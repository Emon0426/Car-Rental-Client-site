...
[#A9CFFF] max-w-6xl mx-3 md:mx-auto rounded-2x1 overflow-hidden'>
<div className='text-white'>
    <h2 className='text-3xl font-medium'>Do You Own a Luxury Car?</h2>
    <p className='mt-2'>Monetize Your  vehicle effortlesly by listening it on CarRental.</p>
    <p className='mx-w-130'>"We take care of insurance, driver verification and secure payments – so you can earn passive income, stress-free."</p>
